...
class LoggerCallback(Callback):
    ...
    def on_validation_batch_start(self, trainer, pl_module, batch: Any, batch_idx: int, dataloader_idx: int) -> None:
        return self._on_batch_start(trainer, pl_module)
...
def build_logger(cfg):
    if cfg.logging == 'none':
        ...
        with lockfile:
            ...
            log = MyWandbLogger(
                entity=cfg.environment.wandb.user,
