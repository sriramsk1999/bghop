...
class VectorQuantizer(nn.Module):
    ...
    def forward(self, z, temp=None, rescale_logits=False, return_logits=False, is_voxel=True):
        ...
        perplexity = None
        min_encodings = None
        # print(f'z_flatten {z_flattened.shape}. d {d.shape}. min_encoding_indices {min_encoding_indices.shape}. z_q {z_q.shape}. weights {self.embedding.weight.shape}')
